...
sqlplus %InstallUser%/%InstallPWD%@%SID% @install_scripts/install_sample.sql %InstallUser% %RemoteUser%

sqlplus %RemoteUser%/%RemotePWD%@%SID% @install_scripts/install_sample_app.sql %InstallUser% %RemoteUser% %ApexWorkspace% %AppId%
