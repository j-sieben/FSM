...
sqlplus ${REMOTE_USER}/"${REMOTE_PWD}"@${SERVICE} @./install_scripts/uninstall_sample_app.sql ${INSTALL_USER} ${REMOTE_USER} ${APEX_WS} ${APEX_APP_ID}

sqlplus ${INSTALL_USER}/"${INSTALL_PWD}"@${SERVICE} @./install_scripts/uninstall_sample.sql ${INSTALL_USER} ${REMOTE_USER}
