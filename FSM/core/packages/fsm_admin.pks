...
as
   ...
   * @usage  Used to create or maintain a class at view FSM_CLASSES_V.
   */
   ...
   * @param  p_fsg_fcl_id       Reference to FSM_CLASSES
   ...
   * @usage  Is used to maintain status group meta data at view FSM_STATUS_GROUPS_V.
   */
   ...
   * @usage  Is used to maintain event meta data at view FSM_STATUS_V.
   */
   ...
   * @usage  Is used to maintain event meta data at view FSM_EVENTS_V.
   */
   ...
   * @usage  Is used to maintain transition meta data at view FSM_TRANSITIONS.
   */
