...
select fsm_id, fsm_fcl_id, fsm_fsc_id,
       ...
       fsm_fms_id, fms_name fsm_monitor_status_name,
       fms_display_name fsm_monitor_status_display_name,
       fms_description fsm_monitor_status_description,
       fms_sort_seq fsm_monitor_status_sort_seq,
       fsm_monitor_status_date,
       fsm_fms_id fsm_status_state
  from fsm_objects
  join fsm_classes_v
  ...
  join fsm_monitor_status_v
    on fsm_fms_id = fms_id;
