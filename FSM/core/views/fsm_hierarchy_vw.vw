create or replace force view fsm_hierarchy_vw as 
select level lvl,
   ...
   from (select ftr.*,
           ...
           join fsm_status fst on ftr.ftr_fst_id = fst.fst_id and ftr_fcl_id = fst_fcl_id
           join fsm_event fev on ftr.ftr_fev_id = fev.fev_id and ftr_fcl_id = fev_fcl_id
