...
sqlplus %InstallUser%/"%InstallPWD%"@%SID% @install_scripts/revoke_client_access %InstallUser% %RemoteUser%

sqlplus %RemoteUser%/"%RemotePWD%"@%SID% @install_scripts/uninstall_client %InstallUser% %RemoteUser%
