...
select req_id, fsm_id req_fsm_id, fsm_fcl_id req_fcl_id, fsm_fsc_id req_fsc_id,
       fsm_fst_id req_fst_id, fsm_fev_id req_fev_id, fsm_fev_list req_fev_list,
