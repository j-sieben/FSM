...
echo -n "Enter schema that holds the sample business logic [ENTER] "
read OWNER
echo ${OWNER}
...
sqlplus ${REMOTEOWNER}/"${REMOTEPWD}"@${SERVICE} @./install_scripts/uninstall_sample_app.sql ${OWNER} ${REMOTEOWNER} ${APEX_WS} ${APEX_APP_ID}

sqlplus ${OWNER}/"${CLIENTPWD}"@${SERVICE} @./install_scripts/uninstall_sample.sql ${OWNER} ${REMOTEOWNER}
