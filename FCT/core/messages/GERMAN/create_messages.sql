begin
  ...
  pit_admin.merge_message(
    ...
    p_pms_pmg_name => '&TOOLKIT.',
    p_pms_text => q'^#1#-&TOOLKIT. mit ID #2# erstellt.^',
    p_pms_description => q'^^',
    p_pms_pse_id => 70,
    p_pms_pml_name => 'GERMAN',
    p_error_number => null
  ...
  pit_admin.merge_message(
    ...
    p_pms_pmg_name => '&TOOLKIT.',
    p_pms_text => q'^&TOOLKIT._ID #1# existiert nicht, es wurde keine Aktion gestartet.^',
    p_pms_description => q'^Es wurde versucht, eine &TOOLKIT.-Instanz zu erzeugen, die nicht persistiert ist. Stellen Sie sicher, nur existierende Objekte zu instanziieren oder erstellen Sie eine neue Instanz.^',
    p_pms_pse_id => 30,
    p_pms_pml_name => 'GERMAN',
    p_error_number => -20000
  );
  ...
  pit_admin.merge_message(
    ...
    p_pms_pmg_name => '&TOOLKIT.',
    p_pms_text => q'^Handler für das &TOOLKIT.-Ereignis #1# konnte in Package #2# nicht gefunden werden.^',
  ...
  pit_admin.merge_message(
    ...
    p_pms_pmg_name => '&TOOLKIT.',
    p_pms_text => q'^&TOOLKIT. hat die Vearbeitung abgeschlossen.^',
    p_pms_description => q'^^',
    p_pms_pse_id => 40,
    p_pms_pml_name => 'GERMAN',
    p_error_number => null
  ...
  pit_admin.merge_message(
    ...
    p_pms_pmg_name => '&TOOLKIT.',
    p_pms_text => q'^&TOOLKIT.-Vearbeitung fehlgeschlagen.^',
    p_pms_description => q'^^',
    p_pms_pse_id => 40,
    p_pms_pml_name => 'GERMAN',
    p_error_number => null
